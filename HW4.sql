...
/*alter table employees_salary2 
rename column imployees_id to imployees_id;*/
...
right outer join salary2 on
employees.id = salary2.id;
...
salary2.id = employees.id;
 

select employee_name, role_name 
from employees
left outer join roles2 
...
right outer join roles2 on
employees.id = roles2.id
right outer join salary2 on
employees.id = salary2.id;
...
/*select * from employees
full outer join roles2 on
employees.id = roles2.id
full outer join salary2 on
employees.id = salary2.id;


select * from employees
left outer join roles2 on
employees.id = roles2.id
left outer join salary2 on
employees.id = salary2.id;
